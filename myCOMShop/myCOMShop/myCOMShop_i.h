...
EXTERN_C const IID IID_ImyShop;
    ...
    MIDL_INTERFACE("BEC2AA9F-32AF-4330-AD96-4E8B6E2CCCD4")
    ...
    public:
        ...
        virtual /* [id] */ HRESULT STDMETHODCALLTYPE getNamesByIndex( 
            /* [in] */ LONG index,
    ...
    typedef struct ImyShopVtbl
    {
        ...
        /* [id] */ HRESULT ( STDMETHODCALLTYPE *getNamesByIndex )( 
            ImyShop * This,
            /* [in] */ LONG index,
...
#define ImyShop_getNamesByIndex(This,index,name)	\
    ( (This)->lpVtbl -> getNamesByIndex(This,index,name) ) 
...
class DECLSPEC_UUID("D50D929A-BA0A-437B-9B39-E78B15B9CBCB")
myShop;
#endif
